...
final class FriendlyWarriorNpcComponent extends BaseNpcComponent {
  ...
  late final FriendlyNpcAnimator animationGroupComponent;
  ...
  @override
  FutureOr<FriendlyNpcAnimator> provideAnimationGroupComponent() => FriendlyWarAnimator(
        position: size / 2,
        size: size,
        anchor: Anchor.center,
        animatorCallbacks: FriendlyNpcAnimatorCallbacks()
